...
import { AlertTriangle, CheckCircle2, Timer, Trash2, XCircle } from 'lucide-react';
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-600">Please read carefully: {remainingSeconds} seconds remaining</span>
          </div>
          <Progress
            percent={progress}
            showInfo={false}
        ...
        <div className="rounded-lg p-4 border border-gray-200 bg-gray-50 space-y-2">
          ...
          <p className="text-sm text-gray-600 mb-2">
            Type "<span className="font-bold">{assessmentName}</span>" exactly to confirm deletion:
          </p>
          <Input
            value={inputValue}
