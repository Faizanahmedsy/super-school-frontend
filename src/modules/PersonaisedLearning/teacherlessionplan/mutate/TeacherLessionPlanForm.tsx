...
const TeacherLessionPlanForm = ({ form, handleSubmit }: Props) => {
  const [stateId, setStateId] = useState<number | undefined>(undefined);
  return (
    <Form form={form} layout="vertical" onFinish={handleSubmit}>
      <div className="grid md:grid-cols-4 gap-4">
        <Form.Item label="TeacherLessionPlan Name" name="teacherlessionplan_name">
          <Input type="text" />
        </Form.Item>
...
export default TeacherLessionPlanForm;
