...
export default function ManualReviewAssessmentDetails() {
  ...
  const handleDetails = (id: number, gradeId: number) => {
    navigate(`/manual-review/assessment/subject-details/${id}?grade_class=${gradeId}`);
  };
        ...
        <PageTitle
          breadcrumbs={[
            { label: 'Manual Review', href: '/manual-review' },
            {
              ...
              href: `/manual-review/assessment/details/${subjectDetailsId.subjectdetailsid?.id}`,
            },
          ]}
        >
          Assessment Details
