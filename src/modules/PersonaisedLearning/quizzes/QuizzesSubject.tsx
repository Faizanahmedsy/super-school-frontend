...
export default function QuizzesSubject() {
  ...
  return (
    <>
      <PageTitle
        breadcrumbs={[
          { label: 'Select Grades ', href: '/batch/list' },
          { label: 'Select Subject ', href: '/batch/list' },
        ]}
      >
        Quizzes
      </PageTitle>
      ...
      <Card className="">
        <CardHeader className="relative z-10">
          <CardTitle>Select a Subjects</CardTitle>
            ...
            {data.map((batch, index) => (
              ...
              >
                <Card
                  ...
                  onClick={() => navigate('/quiz/individual')}
                >
                  <div
