...
// Super School CUSTOM STYLES START ==================================================================================
  ...
  /* General styles for select dropdown arrow */
.ant-select .ant-select-arrow {
  margin-top: auto !important;
}

/* Selector styles for single and multi-select */
.ant-select-single .ant-select-selector,
...
/* Hover effect for single and multi-select */
.ant-select:hover .ant-select-selector {
  // border-color: var(--primary) !important;
  box-shadow: none !important;
  outline: none;
...
/* Focused effect for single and multi-select */
.ant-select-focused .ant-select-selector {
  // border-color: var(--primary) !important;
  box-shadow: none !important;
  outline: none;
...
/* Reset background for option content */
.ant-select-item-option-content {
  background-color: transparent !important;
}

/* Adjust multi-select specific styling */
...
//   }
  ...
  .ant-form-item:hover .ant-form-item-label > label {
    color: #0f172a;
  }
 ...
 .ant-btn-variant-solid:disabled {
  ...
  .custom-select .ant-form-item-explain-error{
  padding-top:8px !important;
  border-color: #ff4d4f !important;
  }

.ui-custom-multi-select .ant-select-selection-wrap {
  align-self: center;
...
.answersheet-tabs .ant-tabs-nav-wrap {
width: 100% !important;
display: flex;
align-items: center;
justify-content: center;
...
// Super School CUSTOM STYLES END ==================================================================================
`;
