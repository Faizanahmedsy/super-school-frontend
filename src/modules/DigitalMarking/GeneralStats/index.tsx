...
import { AcademicStatsType } from '@/app/types/models/dashboards/AcademyType';
    ...
    <AppCard heightFull className="card-hover">
      <StyledGeneralStats>
        ...
        <StyledGeneralStatsContent>
          ...
          <StyledGeneralStatsBadge style={{ backgroundColor: stats.bgcolor, color: stats.badgeColor }}>
            {stats.new}
          </StyledGeneralStatsBadge>
        </StyledGeneralStatsContent>
      </StyledGeneralStats>
